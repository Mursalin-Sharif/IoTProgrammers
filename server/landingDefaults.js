const { landingComparisonDefaults } = require('./comparisonDefaults');
const { landingPricingDefaults } = require('./pricingDefaults');
...
module.exports = { landingDefaults, landingWhatsappCta };
